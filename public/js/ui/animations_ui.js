  ...
  animateLargestArmy(pid, p, count) {
    ...
    this.$el.innerHTML = `
      ...
      <div class="container">
        ...
        <div class="card card--md knight second" data-card="dK"></div>
        <div class="card card--md knight first" data-card="dK"></div>
        <div class="card card--md knight third" data-card="dK"></div>
      </div>
    `
